module.exports = (name, status,data) => `
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainer">
                                                <tr>
                                                    <td valign="top" class="bodyContent" mc:edit="body_content" style="text-align:center;">
                                                        ...
                                                        <p>Your Stellar Key is <strong>${status}</strong>. Please check your account draft.</p>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="${data}" height="200px" width="200px" alt="QR Code Image">
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter">
                                                <tr>
                                                    <td valign="top" width="100%" mc:edit="footer_unsubscribe">
                                                        <h6 style="text-align:center;">Fluid Fintec</h6>
                                                        <h6 style="text-align:center;">Galway City</h6>
                                                        <h6 style="text-align:center;">Ireland</h6>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
