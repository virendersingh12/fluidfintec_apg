...
const search = async (filter = {}) => {
  ...
  return Merchant
    .find(filterOptions)
    .select('_id email contactName companyName role  einNumber offerCode phoneNumberCall phoneNumberSMS status publicKey apiKey apiSecretKey paymentProcessor SAreferenceNumber SAmerchantReferenceNumber merchantId');
};
