...
router.post(
  ...
  merchantController.resendActivationEmail
);
...
//get all transactions of  merchants of sales agent
router.post(
  '/getSAmerchantsTransactions',
  authMiddleware,
  // roleMiddleware([ROLES.SALES_AGENT]),
  merchantController.getSAmerchantsTransactions
);
router.post(
  '/getTotalEarningById',
  authMiddleware,
  // roleMiddleware([ROLES.SALES_AGENT]),
  merchantController.getTotalEarningById
);
router.post(
  '/getSAMerchantById',
  authMiddleware,
  // roleMiddleware([ROLES.SALES_AGENT]),
  merchantController.getSAMerchantById
);
